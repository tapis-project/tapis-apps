...
//      apps[i] = new App(-1, tenantName, name, "description "+suffix, App.AppType.LINUX, ownerUser,
...
//              false, "jobLocalWorkDir"+suffix, "jobLocalArchDir"+suffix, "jobRemoteArchApp"+suffix,"jobRemoteArchDir1"+suffix,
