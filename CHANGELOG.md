...
Incremental improvements, security patches in shared libraries. Bug fix.
...
### Breaking changes:
- Remove support for deprecated runtime option SINGULARITY_START

### New features:
- Log service configuration parameters at start-up.
