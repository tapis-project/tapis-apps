...
public final class IntegrationUtils
{
  ...
  public static final List<RuntimeOption> runtimeOptions2 = new ArrayList<>(List.of(RuntimeOption.SINGULARITY_RUN));
  ...
  public static final List<RuntimeOption> runtimeOptionsSingStart = new ArrayList<>(List.of(RuntimeOption.SINGULARITY_START));
