...
public class AppsVersions extends TableImpl<AppsVersionsRecord> {
     ...
     */
    public final TableField<AppsVersionsRecord, LocalDateTime> CREATED = createField(DSL.name("created"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field("(now() AT TIME ZONE 'utc'::text)", SQLDataType.LOCALDATETIME)), this, "UTC time for when record was created");

    /**
     * The column <code>tapis_app.apps_versions.updated</code>. UTC time for
     * when record was last updated
     */
    public final TableField<AppsVersionsRecord, LocalDateTime> UPDATED = createField(DSL.name("updated"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field("(now() AT TIME ZONE 'utc'::text)", SQLDataType.LOCALDATETIME)), this, "UTC time for when record was last updated");
    ...
    /**
     * The column <code>tapis_app.apps_versions.version_enabled</code>.
     */
