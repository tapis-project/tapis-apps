...
public class AppUpdates extends TableImpl<AppUpdatesRecord> {
     ...
     * record was created
     */
    public final TableField<AppUpdatesRecord, LocalDateTime> CREATED = createField(DSL.name("created"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field("(now() AT TIME ZONE 'utc'::text)", SQLDataType.LOCALDATETIME)), this, "UTC time for when record was created");
