...
public class ContainerArgs extends TableImpl<ContainerArgsRecord> {
    ...
    /**
     * The column <code>tapis_app.container_args.name</code>.
     */
    public final TableField<ContainerArgsRecord, String> NAME = createField(DSL.name("name"), SQLDataType.CLOB, this, "");

    /**
     * The column <code>tapis_app.container_args.description</code>.
     */
    public final TableField<ContainerArgsRecord, String> DESCRIPTION = createField(DSL.name("description"), SQLDataType.CLOB, this, "");

    /**
     * The column <code>tapis_app.container_args.input_mode</code>.
     */
    public final TableField<ContainerArgsRecord, InputMode> INPUT_MODE = createField(DSL.name("input_mode"), SQLDataType.CLOB.nullable(false), this, "", new EnumConverter<String, InputMode>(String.class, InputMode.class));

    /**
     * The column <code>tapis_app.container_args.meta</code>.
     */
    public final TableField<ContainerArgsRecord, String[]> META = createField(DSL.name("meta"), SQLDataType.CLOB.getArrayDataType(), this, "");
