...
public class AppsRecord extends UpdatableRecordImpl<AppsRecord> implements Record12<Integer, String, String, String, AppType, String, Boolean, Boolean, String, Boolean, LocalDateTime, LocalDateTime> {

    private static final long serialVersionUID = 720807604;
    ...
    /**
     * Setter for <code>tapis_app.apps.import_ref_id</code>. Optional reference ID for resource created via import
     */
    ...
    /**
     * Getter for <code>tapis_app.apps.import_ref_id</code>. Optional reference ID for resource created via import
     */
    ...
    @Override
    public Row12<Integer, String, String, String, AppType, String, Boolean, Boolean, String, Boolean, LocalDateTime, LocalDateTime> valuesRow() {
    ...
    @Override
    public AppsRecord values(Integer value1, String value2, String value3, String value4, AppType value5, String value6, Boolean value7, Boolean value8, String value9, Boolean value10, LocalDateTime value11, LocalDateTime value12) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AppsRecord(Integer seqId, String tenant, String id, String latestVersion, AppType appType, String owner, Boolean enabled, Boolean containerized, String importRefId, Boolean deleted, LocalDateTime created, LocalDateTime updated) {
        super(Apps.APPS);
