...
public class AppsRecord extends UpdatableRecordImpl<AppsRecord> {
    ...
    private static final long serialVersionUID = 177890169;
    ...
    /**
     * Setter for <code>tapis_app.apps.command</code>.
     */
    ...
    /**
     * Getter for <code>tapis_app.apps.command</code>.
     */
    ...
    /**
     * Setter for <code>tapis_app.apps.exec_codes</code>.
     */
    public void setExecCodes(String[] value) {
        set(12, value);
    }

    /**
     * Getter for <code>tapis_app.apps.exec_codes</code>.
     */
    ...
    /**
     * Setter for <code>tapis_app.apps.use_dtn_if_defined</code>.
     */
    public void setUseDtnIfDefined(Boolean value) {
        set(23, value);
    }

    /**
     * Getter for <code>tapis_app.apps.use_dtn_if_defined</code>.
     */
    public Boolean getUseDtnIfDefined() {
    ...
    public AppsRecord(Integer seqId, String tenant, String id, String version, String description, AppType appType, String owner, Boolean enabled, Boolean containerized, ContainerRuntime containerRuntime, String containerImage, String command, String[] execCodes, Boolean dynamicExecSystem, String[] execSystemConstraints, String execSystemId, String execSystemExecDir, String execSystemInputDir, String execSystemOutputDir, String execSystemLogicalQueue, String archiveSystemId, String archiveSystemDir, Boolean archiveOnAppError, Boolean useDtnIfDefined, String jobDescription, Integer maxJobs, Integer maxJobsPerUser, Integer nodeCount, Integer coresPerNode, Integer memoryMb, Integer maxMinutes, String[] archiveIncludes, String[] archiveExcludes, String[] tags, JsonElement notes, String importRefId, Boolean deleted, LocalDateTime created, LocalDateTime updated) {
        ...
        set(11, command);
        set(12, execCodes);
        set(13, dynamicExecSystem);
        set(14, execSystemConstraints);
        set(15, execSystemId);
        ...
        set(22, archiveOnAppError);
        set(23, useDtnIfDefined);
        set(24, jobDescription);
        set(25, maxJobs);
        set(26, maxJobsPerUser);
        set(27, nodeCount);
        set(28, coresPerNode);
        set(29, memoryMb);
        set(30, maxMinutes);
        set(31, archiveIncludes);
        set(32, archiveExcludes);
        set(33, tags);
        set(34, notes);
        set(35, importRefId);
        set(36, deleted);
