          ...
          throws TapisException, IllegalStateException
  {
    ...
    try
    {
      ...
      Record record = db.insertInto(APPS_VERSIONS)
              ...
              .set(APPS_VERSIONS.DTN_SYSTEM_INPUT_STAGING_DIR, app.getDtnSystemInputStagingDir())
              .set(APPS_VERSIONS.DTN_SYSTEM_OUTPUT_STAGING_DIR, app.getDtnSystemOutputStagingDir())
  ...
  public void putApp(ResourceRequestUser rUser, App putApp, String changeDescription, String rawData)
    ...
    try
    {
      ...
      var result = db.update(APPS_VERSIONS)
              ...
              .set(APPS_VERSIONS.DTN_SYSTEM_INPUT_STAGING_DIR, putApp.getDtnSystemInputStagingDir())
              .set(APPS_VERSIONS.DTN_SYSTEM_OUTPUT_STAGING_DIR, putApp.getDtnSystemOutputStagingDir())
  ...
  public void patchApp(ResourceRequestUser rUser, String appId, String appVersion, App patchedApp,
    ...
    try
    {
      ...
      var result = db.update(APPS_VERSIONS)
              ...
              .set(APPS_VERSIONS.DTN_SYSTEM_INPUT_STAGING_DIR, patchedApp.getDtnSystemInputStagingDir())
              .set(APPS_VERSIONS.DTN_SYSTEM_OUTPUT_STAGING_DIR, patchedApp.getDtnSystemOutputStagingDir())
...
//    flyway.repair();
  ...
  private static App getAppFromJoinRecord(Record r)
  {
    ...
    app = new App(appSeqId, appVerSeqId, r.get(APPS.TENANT), r.get(APPS.ID), r.get(APPS_VERSIONS.VERSION),
            ...
            r.get(APPS_VERSIONS.DTN_SYSTEM_INPUT_STAGING_DIR), r.get(APPS_VERSIONS.DTN_SYSTEM_OUTPUT_STAGING_DIR),
