...
public class NotificationMechanismsRecord extends UpdatableRecordImpl<NotificationMechanismsRecord> implements Record5<Integer, Integer, NotificationMechanismType, String, String> {
     ...
     */
    public void setMechanism(NotificationMechanismType value) {
        set(2, value);
    }
     ...
     */
    public NotificationMechanismType getMechanism() {
        return (NotificationMechanismType) get(2);
    }
    ...
    @Override
    public Row5<Integer, Integer, NotificationMechanismType, String, String> valuesRow() {
    ...
    @Override
    public Field<NotificationMechanismType> field3() {
    ...
    @Override
    public NotificationMechanismType component3() {
        return getMechanism();
    }
    ...
    @Override
    public NotificationMechanismType value3() {
        return getMechanism();
    }
    ...
    @Override
    public NotificationMechanismsRecord value3(NotificationMechanismType value) {
        setMechanism(value);
        return this;
    }
    ...
    @Override
    public NotificationMechanismsRecord values(Integer value1, Integer value2, NotificationMechanismType value3, String value4, String value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public NotificationMechanismsRecord(Integer seqId, Integer subscriptionSeqId, NotificationMechanismType mechanism, String webhookUrl, String emailAddress) {
        super(NotificationMechanisms.NOTIFICATION_MECHANISMS);
