...
public class AppArgs extends TableImpl<AppArgsRecord> {
    ...
    private static final long serialVersionUID = 93591112;
    ...
    /**
     * The column <code>tapis_app.app_args.meta_kv</code>.
     */
    public final TableField<AppArgsRecord, String[]> META_KV = createField(DSL.name("meta_kv"), org.jooq.impl.SQLDataType.CLOB.getArrayDataType(), this, "");

    /**
     * The column <code>tapis_app.app_args.created</code>.
     */
    public final TableField<AppArgsRecord, LocalDateTime> CREATED = createField(DSL.name("created"), org.jooq.impl.SQLDataType.LOCALDATETIME.nullable(false).defaultValue(org.jooq.impl.DSL.field("timezone('utc'::text, now())", org.jooq.impl.SQLDataType.LOCALDATETIME)), this, "");

    /**
     * The column <code>tapis_app.app_args.updated</code>.
     */
    public final TableField<AppArgsRecord, LocalDateTime> UPDATED = createField(DSL.name("updated"), org.jooq.impl.SQLDataType.LOCALDATETIME.nullable(false).defaultValue(org.jooq.impl.DSL.field("timezone('utc'::text, now())", org.jooq.impl.SQLDataType.LOCALDATETIME)), this, "");
