...
public class SchedulerOptions extends TableImpl<SchedulerOptionsRecord> {
     ...
     */
    public final TableField<SchedulerOptionsRecord, String> ARG_VAL = createField(DSL.name("arg_val"), org.jooq.impl.SQLDataType.VARCHAR(128).nullable(false).defaultValue(org.jooq.impl.DSL.field("''::character varying", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
