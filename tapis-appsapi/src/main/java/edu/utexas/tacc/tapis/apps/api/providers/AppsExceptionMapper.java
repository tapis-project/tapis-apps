package edu.utexas.tacc.tapis.apps.api.providers;
 ...
 */
public class AppsExceptionMapper implements ExceptionMapper<Exception>
{
  private static final Logger log = LoggerFactory.getLogger(AppsExceptionMapper.class);
